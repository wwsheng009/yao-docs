...
<template>
  <div
    class="copyright px-[1.2rem] relative py-[1rem] border-1 border-[var(--vp-c-border)]/[.55] w-full min-h-[32px] border-solid mt-[32px] leading-[24px] rounded-[4px]"
  >
    ...
    <section class="flex flex-col gap-y-[8px] overflow-hidden">
      ...
      <div>
        ...
        <span>
          ...
          许可协议。转载请注明来自
          <a
            href="https://github.com/wwsheng009/yao-docs"
            rel="noreferrer"
            target="_blank"
            >YaoDocs</a
          ></span
