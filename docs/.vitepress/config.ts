...
// const { defineConfig } =  import('vitepress');
import { withPwa } from '@vite-pwa/vitepress';
import { mkdir, writeFile } from 'node:fs/promises';
import { withMermaid } from 'vitepress-plugin-mermaid';

import { description, github, keywords, name, site } from './meta.js';
import { pwa } from './plugins/pwa.js';
import sidebar from './sidebar.js';
import nav from './nav.js';
import socialLinks from './link.js';
...
${files
  ...
  .join('\n')}
      ...
      mkdir('dist/yao-docs', { recursive: true });
      writeFile('dist/yao-docs/sitemap.xml', sitemapContent);
    }
  })
);
